    ...
    return (
      <div className="mainContent">
        <span>
          ...
          programs at Uppsala University. Managing around 60 volunteers and 90
          new students. In an event reaching more than 1200 people.
          <br></br>
          <b>Scholarships</b>
          <br></br>I have recieved scholarships from Sweden-Japan foundation,
          Anna Whitlocks Minnesfond & Anna och Edwin Bergers stiftelse for my
          upcoming studies in Japan. Thank you for believing in me! :)
        </span>
      </div>
    );
  }
