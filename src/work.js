    ...
    return (
      <div className="mainContent mainList">
        <span>
          ...
          services like Spotify and Apple Music. More information, as well as
          soundbites, can be found in the "media" section of this website.
          <br></br>
          ...
          Substituting for classes 1 through 5 (7 year to 11 year old students)
          mainly.
          <i>November 2017 - March 2018 </i>
          <br></br>
          <b>Storage - Höganäs </b>
          Responsible for keeping inventory and accepting deliveries at Höganäs
          Halmstadbruken.
